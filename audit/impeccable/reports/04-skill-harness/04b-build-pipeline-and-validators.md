...
fail-open) to [`../05-hook-system/05-hook-system.md`](../05-hook-system/05-hook-system.md). This report covers only
...
fail-open behavior, the detector invocation) — is [`../05-hook-system/05-hook-system.md`](../05-hook-system/05-hook-system.md).
